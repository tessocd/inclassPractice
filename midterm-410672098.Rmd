...
hwGrades[aaa,] -> hwGradesSubsample
```
...
```{r ans17}
classSurvey$學號[(classSurvey$性別=="女性")] ->女性學號
...
mean(hwGradesSubsample[(hwGradesSubsample$女性 == TRUE & hwGradesSubsample$團隊活動 == TRUE),]$平均成績)
```
